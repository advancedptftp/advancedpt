                    ...
                    $(settings.input_field).change(function () {
                        ...
                        if (files.length > 0) {
                            ...
                            if (settings.no_label == false) {
                                // Change label
                                $(settings.label_field).html(file.name);
                            }
